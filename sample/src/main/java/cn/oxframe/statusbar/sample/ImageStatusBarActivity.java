...
public class ImageStatusBarActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnChangeBackground = findViewById(R.id.btn_change_background);
        ...
        mBtnChangeBackground.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isBgChanged) {
                    mRootLayout.setBackground(iDrawable(R.drawable.bg_girl));
                } else {
                    mRootLayout.setBackground(iDrawable(R.drawable.bg_monkey));
                }
            }
        });
    ...
    protected void setStatusBar() {
        if (isTransparent) {
            OxStatusbar.setTransparent(this);
        } else {
            OxStatusbar.setTranslucent(this, OxStatusbar.DEFAULT_STATUS_BAR_ALPHA);
        }
    }
    ...
    private void setSeekBar() {
        ...
        mSbChangeAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mAlpha = progress;
                OxStatusbar.setTranslucent(ImageStatusBarActivity.this, mAlpha);
