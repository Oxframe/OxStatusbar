...
public class UseInFragmentActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mVpHome.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager(), 1) {
            @Override
    ...
    protected void setStatusBar() {
        OxStatusbar.setTranslucentForImageViewInFragment(UseInFragmentActivity.this, null);
    }
}
