    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSetLightMode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                OxStatusbar.setColor(SwitchModeActivity.this, color, 30);
                mToolbar.setBackgroundColor(color);
                OxStatusbar.setLightMode(SwitchModeActivity.this);
            }
        });
        ...
        mBtnSetDarkMode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                OxStatusbar.setColor(SwitchModeActivity.this, color);
                mToolbar.setBackgroundColor(color);
                OxStatusbar.setDarkMode(SwitchModeActivity.this);
            }
        });
    }
